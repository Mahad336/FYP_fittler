...
export const data = [
  ...
  [
    ...
    30,
    'task',
    'Lie on your back with your knees bent and your arms stretched forward. Then lift your upper body off the floor.',
  ],
  [
    4,
    IconPushup,
  ...
  [
    ...
    30,
    'task',
    'Lie down on your back, and put your hands beneath your hips for support. Then lift your legs up until they form a right angle with the floor. Slowly bring your legs down and repeat the exercise',
  ],
  [
    10,
    IconPlank,
  ...
  [
    ...
    30,
    'time',
    'Lie down on your stomach and bend your elbows with your hands beneath your shoulders. Then push your chest up off the ground as for as possible',
  ],
  [
    12,
    IconSpine,
  ...
  [
    ...
    30,
    'time',
    'Stand up with your feet shoulder-width apart. Bend your knees, press your hips back and stop the movement once the hip joint is slightly lower than the knees. Press your heels into the floor to return to the initial position. Repeat until set is complete. Proper Form And Breathing Pattern.',
  ],
];
