    ...
    <View
      ...
      <Image
        ...
        style={{
          width: '100%',
          height:
            prop.txt == 'SPIDERMAN PUSH-UPS' ||
            prop.txt == 'TRIANGLE (DIAMOND) PUSH-UPS'
              ? '40%'
              : '50%',
          resizeMode: 'contain',
        }}
        ...
        {count < 2 ? (
          ...
          <View
            ...
            <Text
              ...
              Take rest for a few second ...
            </Text>
            <TouchableOpacity
              onPress={() => {
                props.navigation.navigate('Works');
              }}>
              <Text style={{ color: '#1E7BF6', fontWeight: 'bold' }}>
                Go back and start next task{' '}
              </Text>
            </TouchableOpacity>
          </View>
        )}
